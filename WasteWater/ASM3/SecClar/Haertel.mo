  ...
  package Interfaces 
    ...
    connector UpperLayerPin "Connector above influent layer" 
      ...
      annotation (Coordsys(
          ...
          grid=[2, 2], 
          component=[20, 20]), Documentation(info=
...
"), 
      ...
      Window(
        ...
        height=0.49));
  equation 
    connect(S1.Up, S2.Dn) annotation (points=[-2.22045e-15, -78; -
          2.22045e-15, -74]);
  ...
  model bottom_layer "Bottom layer of Haertel`s SC model" 
    ...
    ASM3.Interfaces.WWFlowAsm3out PQr annotation (extent=[-70, -110; -50, -90])
      ;
    ASM3.Interfaces.WWFlowAsm3out PQw annotation (extent=[40, -110; 60, -90]);
...
"), 
  ...
  model feed_layer "Influent layer of Haertel`s SC model" 
    ...
    ASM3.Interfaces.WWFlowAsm3in In annotation (extent=[-110, -6; -90, 14]);
    annotation (
      Coordsys(
        extent=[-100, -100; 100, 100], 
        grid=[2, 2], 
...
"), 
  ...
  model top_layer "Effluent layer of Haertel`s SC model" 
    ...
    WWSC.UpperLayerPin Dn annotation (extent=[-10, -110; 10, -90]);
    ASM3.Interfaces.WWFlowAsm3out Out annotation (extent=[90, -10; 110, 10]);
    annotation (
      Coordsys(
        extent=[-100, -100; 100, 100], 
        grid=[2, 2], 
