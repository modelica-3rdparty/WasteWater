  ...
  class SmallPlant "Small WWTP Configuration" 
    ...
    annotation (
      ...
      Window(
        ...
        width=0.39, 
        height=0.58), 
      Diagram(Line(points=[-93, 88; -88, 88])), 
...
Main Author:
   ...
   email: gerald.reichl@tu-ilmenau.de
"));
    ASM3.EffluentSink Effluent annotation (extent=[88, -18; 108, 2]);
    ASM3.SludgeSink WasteSludge annotation (extent=[86, -58; 106, -38]);
    ASM3.divider2 divider annotation (extent=[20, -6; 40, 14]);
    ASM3.nitri tank3(K_A_NH=0.4, V=1333) annotation (extent=[-6, -6; 14, 14]);
    ASM3.nitri tank2(K_A_NH=0.4, V=1333) annotation (extent=[-32, -6; -12, 14])
      ;
    ASM3.deni tank1(K_A_NH=0.4, V=3000) annotation (extent=[-68, -6; -48, 14]);
    ASM3.mixer3 mixer annotation (extent=[-104, 22; -84, 42]);
    ASM3.WWSource WWSource annotation (extent=[-88, 78; -68, 98]);
    ASM3.blower blower1(Q_max=34574.2654508612) annotation (extent=[-32, -62; -
          12, -42]);
    ASM3.blower blower2(Q_max=34574.2654508612) annotation (extent=[-6, -62; 14
          , -42]);
    ASM3.sensor_O2 sensor_O2 annotation (extent=[0, 18; 20, 38]);
    ...
    Modelica.Blocks.Continuous.PI PI1(k={500}, T={0.001}) annotation (extent=[
          88, 40; 108, 60]);
    Modelica.Blocks.Sources.Constant Constant1 annotation (extent=[-84, -86; -
          64, -66]);
    ASM3.pump RecyclePump(Q_max=46115) annotation (extent=[-94, -22; -74, -2], 
        rotation=180);
    Modelica.Blocks.Sources.Step OxygenSetPoint(height={1.5}) annotation (
        extent=[40, 40; 60, 60]);
    ASM3.pump ReturnPump(Q_max=9223) annotation (extent=[16, -36; 36, -16], 
        rotation=180);
    ASM3.pump WastePump(Q_max=193) annotation (extent=[70, -14; 90, -34]);
    ...
    ModelicaAdditions.Tables.CombiTableTime CombiTableTime(
      ...
      icol={16,10,3,4,12,10,11,15,5,6,7,10,8}) annotation (extent=[-118, 78; -
          98, 98]);
    sensor_NH sensor_NH1 annotation (extent=[78, 16; 94, 32]);
    sensor_NO sensor_NO1 annotation (extent=[92, 16; 108, 32]);
    sensor_COD sensor_COD1 annotation (extent=[64, 16; 80, 32]);
    SecClar.Krebs.SecClarModKrebs Settler annotation (extent=[50, -2; 70, 18]);
  equation 
    connect(tank3.Out, divider.In) annotation (points=[14, 4; 20, 4]
      );
    connect(tank2.Out, tank3.In) annotation (points=[-12, 4; -6, 4]);
    connect(mixer.Out, tank1.In) annotation (points=[-84, 32; -79, 32; -79, 4; 
          -68, 4]);
    connect(mixer.In1, WWSource.Out) annotation (points=[-104, 35.9; -104, 74; 
          -68, 74; -68, 81; -68.2, 81]);
    ...
    connect(tank3.MeasurePort, sensor_O2.In) annotation (points=[9.5, 8.5; 10, 
          8.5; 10, 18]);
    ...
    connect(PI1.outPort, blower2.u) annotation (points=[109, 50; 114, 50; 114, 
          -78; 18, -78; 18, -55; 13.9, -55]);
    connect(divider.Out2, RecyclePump.In) annotation (points=[40, 2.2; 44, 2.2
          ; 44, -8.7; -74, -8.7]);
    connect(RecyclePump.Out, mixer.In3) annotation (points=[-94.2, -14.9; -108
          , -14.9; -108, 26.6; -104, 26.6; -104, 27.1]);
    connect(OxygenSetPoint.outPort, Feedback.inPort1) annotation (points=[61, 
          50; 64, 50]);
    connect(ReturnPump.Out, mixer.In2) annotation (points=[15.8, -28.9; -112, -
          28.9; -112, 32; -104, 32]);
    connect(WastePump.Out, WasteSludge.In) annotation (points=[90.2, -26.9; 100
          , -26.9; 100, -34; 80, -34; 80, -49.2; 86, -49.2]);
    connect(Constant2.outPort, ReturnPump.u) annotation (points=[43, -58; 46, -
          58; 46, -28.5; 34.8, -28.5]);
    connect(Constant2.outPort, WastePump.u) annotation (points=[43, -58; 60, -
          58; 60, -26.5; 71.2, -26.5]);
    connect(sensor_O2.So, Feedback.inPort2) annotation (points=[19.8, 28; 19.85
          , 28; 19.85, 34; 72, 34; 72, 42]);
    connect(blower1.u, Constant1.outPort) annotation (points=[-12.1, -55; -8, -
          55; -8, -76; -63, -76]);
    connect(Temperature.outPort, tank1.T) annotation (points=[-81.5, 56; -74, 
          56; -74, 8; -71, 8; -71, 8; -68, 8], style(color=3));
    connect(Temperature.outPort, tank2.T) annotation (points=[-81.5, 56; -74, 
          56; -74, 14; -32, 14; -32, 8], style(color=3));
    connect(Temperature.outPort, tank3.T) annotation (points=[-81.5, 56; -74, 
          56; -74, 14; -5.9, 14; -5.9, 8; -5.8, 8], style(color=3));
    connect(CombiTableTime.outPort, WWSource.data) annotation (points=[-97, 88
          ; -88, 88], style(color=3));
    connect(tank1.Out, tank2.In) annotation (points=[-48, 4; -32, 4]);
    connect(RecyclePump.u, Constant1.outPort) annotation (points=[-75.2, -14; -
          46, -14; -46, -76; -64, -76], style(color=3));
    connect(Settler.Effluent, Effluent.In) annotation (points=[70.2, 13.7; 72, 
          13.7; 72, -6; 88, -6]);
    connect(Settler.Return, ReturnPump.In) annotation (points=[57, -1.6; 57, -
          22.7; 36, -22.7]);
    connect(Settler.Waste, WastePump.In) annotation (points=[63, -1.6; 63, -
          20.7; 70, -20.7]);
    connect(sensor_COD1.In, Settler.Effluent) annotation (points=[72, 16; 72, 
          13.7; 70.2, 13.7]);
    connect(sensor_NH1.In, Settler.Effluent) annotation (points=[86, 16; 86, 
          13.7; 70.2, 13.7]);
    connect(sensor_NO1.In, Settler.Effluent) annotation (points=[100, 16; 100, 
          13.7; 70.2, 13.7]);
    connect(Settler.Feed, divider.Out1) annotation (points=[50, 8; 40, 8]);
...
"));
    ASM3.EffluentSink Effluent annotation (extent=[90, -16; 110, 4]);
    ASM3.SludgeSink WasteSludge annotation (extent=[86, -58; 106, -38]);
    ASM3.SecClarModTakacs Settler annotation (extent=[48, -2; 68, 18]);
    ASM3.divider2 divider annotation (extent=[20, -6; 40, 14]);
    ASM3.nitri tank5(
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
      V=1333) annotation (extent=[-6, -6; 14, 14]);
    ASM3.nitri tank4(
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
      V=1333) annotation (extent=[-32, -6; -12, 14]);
    ASM3.nitri tank3(
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
      V=1333) annotation (extent=[-60, -6; -40, 14]);
    ASM3.deni tank2(K_A_NH=0.4, b_A_O_T=0.1) annotation (extent=[-48, 22; -28, 
          42]);
    ASM3.deni tank1(K_A_NH=0.4, b_A_O_T=0.1) annotation (extent=[-76, 22; -56, 
          42]);
    ASM3.mixer3 mixer annotation (extent=[-104, 22; -84, 42]);
    ASM3.WWSource WWSource annotation (extent=[-88, 78; -68, 98]);
    ASM3.sensor_NO sensor_NO annotation (extent=[-42, 48; -22, 68]);
    ASM3.blower blower1(Q_max=34574.2654508612) annotation (extent=[-60, -62; -
          40, -42]);
    ASM3.blower blower2(Q_max=34574.2654508612) annotation (extent=[-32, -62; -
          12, -42]);
    ASM3.blower blower3(Q_max=34574.2654508612) annotation (extent=[-6, -62; 14
          , -42]);
    ASM3.sensor_O2 sensor_O2 annotation (extent=[0, 18; 20, 38]);
    Modelica.Blocks.Math.Feedback Feedback annotation (extent=[62, 40; 82, 60])
      ;
    ...
    Modelica.Blocks.Sources.Constant Constant1 annotation (extent=[-84, -86; -
          64, -66]);
    ASM3.pump RecyclePump(Q_max=92230) annotation (extent=[-94, -22; -74, -2], 
        rotation=180);
    ...
    ASM3.pump ReturnPump(Q_max=18446) annotation (extent=[16, -36; 36, -16], 
        rotation=180);
    ASM3.pump WastePump(Q_max=385) annotation (extent=[70, -34; 90, -14]);
    Modelica.Blocks.Sources.Constant Constant2 annotation (extent=[22, -68; 42
          , -48]);
    Modelica.Blocks.Sources.Constant Temperature(k={15}) annotation (extent=[-
          94, 50; -82, 62]);
    ModelicaAdditions.Tables.CombiTableTime CombiTableTime(
      ...
      icol={2,10,3,4,12,10,11,15,5,6,7,10,8}) annotation (extent=[-118, 78; -98
          , 98]);
    ModelicaAdditions.Blocks.Nonlinear.FixedDelay FixedDelay1(delayTime=1/6/24)
       annotation (extent=[-18, 48; 2, 68]);
    sensor_NH sensor_NH1 annotation (extent=[60, 18; 76, 34]);
    WasteWater.ASM3.sensor_NO sensor_NO1 annotation (extent=[92, 18; 108, 34]);
    WasteWater.ASM3.sensor_COD sensor_COD1 annotation (extent=[76, 18; 92, 34])
      ;
  equation 
    connect(divider.Out1, Settler.Feed) annotation (points=[40, 7; 
          40, 9.4; 48, 9.4]);
    ...
    connect(Settler.Effluent, Effluent.In) annotation (points=[68.2, 13.7; 72, 
          13.7; 72, -4; 90, -4]);
    connect(mixer.In1, WWSource.Out) annotation (points=[-104, 35.9; -104, 74; 
          -68, 74; -68, 77.5; -68.2, 77.5; -68.2, 81]);
    ...
    connect(PI1.outPort, blower3.u) annotation (points=[109, 50; 114, 50; 114, 
          -78; 18, -78; 18, -55; 13.9, -55]);
    connect(Constant1.outPort, blower1.u) annotation (points=[-63, -76; -35.1, 
          -76; -35.1, -55; -40.1, -55]);
    connect(divider.Out2, RecyclePump.In) annotation (points=[40, 2.2; 44, 2.2
          ; 44, -8.7; -74, -8.7]);
    connect(RecyclePump.Out, mixer.In3) annotation (points=[-94.2, -14.9; -108
          , -14.9; -108, 26.6; -104, 26.6; -104, 27.1]);
    connect(OxygenSetPoint.outPort, Feedback.inPort1) annotation (points=[58.9
          , 49; 62.5, 49; 62.5, 50; 64, 50]);
    ...
    connect(Limiter1.outPort, Feedback1.inPort2) annotation (points=[29, 58; 32
          , 58; 32, 80]);
    connect(Settler.Return, ReturnPump.In) annotation (points=[55, -1.6; 55, -
          22.7; 36, -22.7]);
    connect(ReturnPump.Out, mixer.In2) annotation (points=[15.8, -28.9; -112, -
          28.9; -112, 32; -104, 32]);
    connect(Settler.Waste, WastePump.In) annotation (points=[61, -1.6; 61, -
          27.3; 70, -27.3]);
    connect(WastePump.Out, WasteSludge.In) annotation (points=[90.2, -21.1; 100
          , -21.1; 100, -34; 80, -34; 80, -49.2; 86, -49.2]);
    connect(Constant2.outPort, ReturnPump.u) annotation (points=[43, -58; 46, -
          58; 46, -28.5; 34.8, -28.5]);
    connect(Constant2.outPort, WastePump.u) annotation (points=[43, -58; 58, -
          58; 58, -21.5; 71.2, -21.5]);
    connect(sensor_O2.So, Feedback.inPort2) annotation (points=[19.8, 28; 60, 
          28; 60, 36; 72, 36; 72, 42]);
    connect(blower2.u, Constant1.outPort) annotation (points=[-12.1, -55; -8, -
          55; -8, -76; -63, -76]);
    connect(Temperature.outPort, tank1.T) annotation (points=[-81.5, 56; -78, 
          56; -78, 36; -75.8, 36], style(color=3));
    connect(Temperature.outPort, tank2.T) annotation (points=[-81.5, 56; -48, 
          56; -48, 36], style(color=3));
    ...
    connect(sensor_NO.In, tank2.MeasurePort) annotation (points=[-32, 48; -32, 
          36.5; -32.5, 36.5]);
    connect(FixedDelay1.inPort, sensor_NO.Sno) annotation (points=[-20, 58; -22
          , 58], style(color=3));
    connect(Limiter1.inPort, FixedDelay1.outPort) annotation (points=[6, 58; 4
          , 58], style(color=3));
    connect(sensor_NH1.In, Settler.Effluent) annotation (points=[68, 18; 68, 
          13.7]);
    connect(sensor_COD1.In, Settler.Effluent) annotation (points=[84, 18; 84, 
          14; 68, 14]);
    connect(sensor_NO1.In, Settler.Effluent) annotation (points=[100, 18; 100, 
          14; 68.2, 14]);
...
"));
    ...
    deni anaerob(
      ...
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
      V=1287) annotation (extent=[-138, 13; -118, 33]);
    deni deni1(
      k_H_T=9.0, 
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
      V=2772) annotation (extent=[-80, 14; -60, 34]);
    deni deni3(
      k_H_T=9.0, 
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
      V=2772) annotation (extent=[80, 18; 100, 38]);
    deni deni2(
      k_H_T=9.0, 
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
      V=2772) annotation (extent=[-20, 14; 0, 34]);
    nitri nitri3(
      k_H_T=9.0, 
      K_A_NH=0.4, 
      b_A_O_T=0.1, 
    ...
    pump ReturnPump(Q_max=60480) annotation (extent=[-54, -104; -34, -84], 
        rotation=180);
    pump RecyclePump(Q_max=60480) annotation (extent=[0, -46; 20, -26], 
        rotation=180);
    ...
    divider2 divider2_1 annotation (extent=[47, -45; 67, -25], rotation=180);
    ...
    sensor_TSS sensor_TSS1 annotation (extent=[-6, -87; 14, -67]);
    ...
    WasteWater.ASM3.sensor_NH sensor_NH1 annotation (extent=[142, 38; 162, 58])
      ;
    ...
    Modelica.Blocks.Math.Feedback Feedback2 annotation (extent=[127, 99; 137, 
          109]);
    WasteWater.ASM3.sensor_O2 sensor_O2_1 annotation (extent=[164, 38; 184, 58]
      );
    WasteWater.ASM3.sensor_O2 sensor_O2_2 annotation (extent=[14, 38; 34, 58]);
    WasteWater.ASM3.sensor_COD sensor_COD1 annotation (extent=[134, -56; 154, -
          36]);
    WasteWater.ASM3.sensor_COD sensor_COD2 annotation (extent=[-118, 94; -98, 
          114]);
    ...
    WasteWater.ASM3.sensor_TKN sensor_TKN1 annotation (extent=[68, -56; 88, -36
          ]);
    ...
    ModelicaAdditions.Tables.CombiTableTime CombiTableTime2(
      tableName="drysim130303", 
      fileName="drysim130303.txt", 
      icol={3,7,4,6}) annotation (extent=[-142, 97; -126, 113]);
    ...
    WasteWater.ASM3.sensor_O2 sensor_O2_3 annotation (extent=[116, 40; 134, 58]
      );
  ...
  equation 
    ...
    connect(deni2.Out, nitri1.In) annotation (points=[5.55112e-16, 24; 12, 24])
      ;
    connect(cdivider2.Out1, mixer2_2.In1) annotation (points=[-22, 80; 40, 80; 
          40, 29.5; 50, 29.5]);
    ...
    connect(Gain3.outPort, blower2.u) annotation (points=[108.7, -21; 139, -21
          ; 139, -6; 129.9, -6], style(color=3));
    connect(blower1.u, Gain2.outPort) annotation (points=[163.9, -6; 195, -6; 
          195, 103; 165, 103], style(color=3));
    connect(Settler.Feed, divider2_1.Out1) annotation (points=[68, -72; 38.1, -
          72; 38.1, -38; 47.1, -38]);
    connect(RecyclePump.Out, ControlledDivider2_1.In) annotation (points=[0, -
          39; -30, -39]);
    connect(RecyclePump.In, divider2_1.Out2) annotation (points=[21, -33; 47, -
          33]);
    connect(ReturnController1.out, ReturnPump.u) annotation (points=[-14, -108
          ; -8, -108; -8, -97; -35, -97], style(color=3));
    connect(Settler.Return, ReturnPump.In) annotation (points=[75, -84; 75, -91
          ; -33, -91]);
    connect(Settler.Return, sensor_TSS1.In) annotation (points=[75, -83.6; 75, 
          -91; 4, -91; 4, -87]);
    connect(sensor_COD1.In, Settler.Effluent) annotation (points=[144, -57; 144
          , -68; 88, -68]);
    connect(blower1.AirOut, nitri3.AirIn) annotation (points=[154, 7; 154, 18])
      ;
    connect(nitri2.AirIn, blower2.AirOut) annotation (points=[120, 18; 120, 7])
      ;
    connect(CombiTableTime2.outPort, Preclaryfier.MeasurePort) annotation (
        points=[-125, 105; -122, 105; -122, 87], style(color=3));
    connect(cdivider2.In, Preclaryfier.Out) annotation (points=[-42, 78; -116, 
          78]);
    connect(mixer2_1.In1, deni1.Out) annotation (points=[-45, 29; -59, 29; -59
          , 24; -60, 24]);
    connect(mixer3_1.In2, anaerob.Out) annotation (points=[-107, 23; -117, 23])
      ;
    connect(nitri1.Out, mixer2_2.In2) annotation (points=[32, 24; 41, 24; 41, 
          25; 50, 25]);
    connect(blower3.AirOut, nitri1.AirIn) annotation (points=[22, -3; 22, 14.2]
      );
